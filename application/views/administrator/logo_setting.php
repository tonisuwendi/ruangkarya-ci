        ...
        <div class="col-md-9">
            <div class="card shadow">
                <div class="card-header">
                    <h2 class="lead text-dark mb-0">Logo</h2>
                </div>
                <div class="card-body">
                    <?php echo $this->session->flashdata('failed'); ?>
                    <img src="<?= base_url(); ?>assets/images/logo/<?= $setting['logo']; ?>" alt="" style="width: 50%">
                    <form action="<?= base_url(); ?>administrator/upload_logo_setting" method="post" enctype="multipart/form-data">
                        <div class="form-group mt-3">
                            <input type="file" class="form-control" name="file6" required>
                        </div>
                        <button class="btn btn-sm btn-info" type="submit">Edit Logo</button>
                    </form>
                </div>
            </div>
        </div>
